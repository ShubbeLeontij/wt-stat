...
viewed_stat: list[STAT] = [STAT.WINRATE, STAT.TIME_FIGHTER, STAT.TIME_ATTACKER, STAT.TIME_TANKS, STAT.TIME_ANTI_AIR, STAT.LEVEL]
load_button: keyboard.Key = keyboard.Key.f11
show_button: keyboard.Key = keyboard.Key.f12
